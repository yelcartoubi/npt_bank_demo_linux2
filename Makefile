...
LDFLAGS += -L$(SDKNAPILIB) -lnapi_c_net -lnapi_c_mdb -lnapi_c_externalmemory -lnapi_c_socket -lnapi_c_fs
LDFLAGS += -L$(SDKNAPILIB) -lnapi_c_ctlscard -lnapi_c_magcard -lnapi_c_smartcard -lnapi_c_scan
...
# model such as SP630/sp630Pro/sp830/sp930/U1000/ME60
MODEL = GCC494
